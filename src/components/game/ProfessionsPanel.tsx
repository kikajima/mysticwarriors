        ...
        <div className="flex flex-col md:flex-row md:items-center gap-5">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-amber-200/60 mt-1 leading-relaxed">
              Escolha quanto tempo seu radar ficará procurando. A chance base cresce até 20%; bônus dos dois espaços de acessório podem elevar a chance total até 50%. Cada busca encontra no máximo uma esfera, não gasta energia e só pode começar se existir uma estrela sem dono no mundo.
            </p>
            {freeBalls !== undefined && (
