...
export function ShenronPanel({
  ...
  // PvE e torneio). Aethelgard pode ser despertado mesmo com o guerreiro em atividade.
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 relative">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="text-sm text-amber-200/60 leading-relaxed mb-4">
              {hasAll
                ? 'Os anéis do Horizonte entram em ressonância. Aethelgard despertou e oferece uma Bênção Primordial.'
              ...
              {Array.from({ length: 7 }, (_, i) => {
                ...
                return (
                  <div
                    ...
                    role="img"
                    aria-label={filled ? `Chave ${i + 1} obtida` : `Chave ${i + 1} faltando`}
                  >
