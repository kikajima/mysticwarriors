...
export const metadata = {
  ...
  description:
    'Catálogo completo das técnicas de Myst Ki Warriors: Garras do Lobo Astral, Onda de Aether, Disco de Ruptura, Ruptura do Horizonte, Convergência do Aether e mais — poder, custo de Ki e mestres que as ensinam.',
