...
export const metadata = {
  ...
  description:
    'As árvores de transformação de Myst Ki Warriors por raça: Oozaru, Super Saiyajin, Super Namekuseijin, Overclock, Caos Desencadeado e os três caminhos finais de cada raça.',
