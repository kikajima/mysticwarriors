...
export const TECHNIQUES: TechniqueDef[] = [
  {
    ...
    description: 'Sequência de golpes angulados inspirada na caça em matilha dos Solaris.',
    type: 'physical',
    category: 'basic',
    power: 1.25,
    kiCost: 10,
  ...
  },
  {
    id: 'megaton_punch',
    name: 'Impacto de Aço',
    description: 'Golpe vanguardiano direto que converte postura, rotação e impulso corporal em impacto concentrado.',
    type: 'physical',
    category: 'basic',
    power: 1.3,
    kiCost: 12,
  ...
  },
  {
    ...
    description: 'Lâmina circular de Aether de alta perfuração: atravessa parte da defesa, mas segue uma trajetória previsível.',
    type: 'energy',
    category: 'basic',
    power: 1.4,
    kiCost: 20,
  ...
  },
  {
    ...
    description: 'Dois fluxos helicoidais de Aether se entrelaçam em um disparo preciso capaz de perfurar parte da defesa.',
    type: 'energy',
    category: 'advanced',
    power: 1.5,
    kiCost: 32,
  ...
  },
  {
    ...
    description: 'O usuário força músculos e canais de energia acima da margem segura para um único ataque devastador.',
    type: 'physical',
    category: 'advanced',
    power: 1.5,
    kiCost: 30,
  ...
  },
  {
    ...
    description: 'Duas correntes laterais convergem em uma descarga linear de altíssima potência.',
    type: 'energy',
    category: 'supreme',
    power: 1.65,
    kiCost: 45,
...
export const TRAINING_MASTERS: TrainingMaster[] = [
  ...
  },
  {
    ...
    quote: '"Precisão vence força bruta quando você sabe exatamente onde romper o fluxo."',
  ...
  },
  {
    ...
    quote: '"Geometria, postura e respiração. A energia obedece melhor quando sua mente já decidiu a forma."',
