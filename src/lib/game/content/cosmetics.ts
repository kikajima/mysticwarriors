...
export const COSMETICS: CosmeticDef[] = [
  ...
  },
  {
    ...
    slot: 'aura',
    name: 'Aura de Fluxo Pulsante',
    description:
      'Um fluxo dourado pulsa ao redor do retrato do seu guerreiro em qualquer tela do jogo.',
    price: 45,
    rarity: 'épico',
    icon: '🌟',
  ...
  },
  {
    ...
    description: 'Entalhada com os padrões orbitais de Aethelgard.',
    price: 45,
    rarity: 'épico',
    icon: '◇',
  ...
  // Fundos de perfil — atrás da ficha de personagem
  {
    ...
    setId: 'caminho_mestre',
    slot: 'background',
    name: 'Fundo: Câmara Temporal',
    description: 'Uma câmara de dilatação temporal envolta em névoa luminosa.',
    price: 20,
    rarity: 'raro',
    icon: '⏳',
  ...
  },
  {
    ...
    slot: 'background',
    name: 'Fundo: Sylva',
    description: 'Florestas titânicas e auroras de energia cobrem o horizonte de Sylva.',
    price: 20,
    rarity: 'raro',
    icon: '🌍',
  ...
  },
  {
    ...
    setId: 'caminho_mestre',
    slot: 'outfit',
    name: 'Traje Branco do Mestre',
    description: 'Vestuário cerimonial dos mestres da Maré Astral.',
    price: 28,
    rarity: 'raro',
    icon: '🥋',
    profileBadge: { icon: '🥋', label: 'Traje Branco do Mestre' },
  ...
  // Identidade social — itens feitos para serem vistos por outros jogadores.
  {
    ...
    setId: 'heranca_dragao',
    slot: 'nameplate',
    name: 'Nameplate do Horizonte',
    description: 'Seu nome aparece em uma placa esmeralda marcada por padrões orbitais.',
    price: 42,
    rarity: 'épico',
    icon: '◇',
  ...
  },
  {
    ...
    description:
      'Sua ficha de personagem emana um brilho místico laranja que pulsa suavemente, como o fluxo de um mestre.',
    price: 60,
    rarity: 'lendário',
    icon: '🃏',
...
export const COSMETIC_SETS: CosmeticSetDef[] = [
  ...
  },
  {
    ...
    icon: '◇',
    description: 'Sylva, Aethelgard e os padrões ancestrais das Chaves do Horizonte.',
    pieceIds: ['frame_dragao', 'bg_planeta_namek', 'nameplate_dragao_eterno'],
    milestones: [
      {
        pieces: 2,
        name: 'Órbita Desperta',
        description: 'A identidade recebe um brilho esmeralda de ressonância orbital.',
      ...
      },
      {
        pieces: 3,
        name: 'Legado Eterno',
        description: 'Conjunto completo: ficha e mensagens carregam a presença do Horizonte.',
