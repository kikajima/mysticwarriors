...
export const COSMETICS: CosmeticDef[] = [
  ...
  },
  {
    ...
    description: 'Entalhada com os padrões orbitais das Chaves do Horizonte.',
    price: 45,
    rarity: 'épico',
    icon: '🐲',
  ...
  },
  {
    ...
    slot: 'background',
    name: 'Fundo: Sylva',
    description: 'Florestas titânicas e auroras de Aether sobre Sylva.',
    price: 20,
    rarity: 'raro',
    icon: '🌍',
  ...
  },
  {
    ...
    description:
      'Sua ficha de personagem emana um brilho místico laranja que pulsa suavemente, como o Aether de um mestre.',
    price: 60,
    rarity: 'lendário',
    icon: '🃏',
...
export const COSMETIC_SETS: CosmeticSetDef[] = [
  ...
  },
  {
    ...
    icon: '🐉',
    description: 'Escamas, Sylva e a assinatura ancestral do dragão.',
