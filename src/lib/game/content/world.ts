...
export const PROFESSION_MATERIALS: ProfessionMaterialDef[] = [
  ...
  { id: 'capsula_vazia_tipo_b', name: 'Contêiner Nexus Tipo-B', professionId: 'cientista', rarity: 'rare', tier: 3, icon: '💊' },
...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'lamina_capsula', name: 'Lâmina de Liga Nexus', description: 'Slot: Arma. Liga tecnológica leve e estável. Bônus: +45 ATQ e +5 VEL.', category: 'weapon', price: 16000, minLevel: 15, atk: 45, spd: 5, icon: '🗡️' },
  ...
  { id: 'capacete_saiyajin_loja', name: 'Capacete Solaris', description: 'Slot: Cabeça. Proteção militar alienígena de linha comercial. Bônus: +8 DEF e +4 KI.', category: 'head', price: 5200, minLevel: 10, def: 8, ki: 4, icon: '🪖' },
  { id: 'coroa_kaio', name: 'Coroa de Foco Astral', description: 'Slot: Cabeça. Foco e proteção para guerreiros experientes. Bônus: +12 DEF, +8 KI e +3 VEL.', category: 'head', price: 14500, minLevel: 16, def: 12, ki: 8, spd: 3, icon: '👑' },
  ...
  { id: 'manoplas_capsula', name: 'Manoplas Nexus', description: 'Slot: Punhos. Placas leves de impacto da Corporação Cápsula. Bônus: +14 ATQ e +4 DEF.', category: 'wrists', price: 3600, minLevel: 8, atk: 14, def: 4, icon: '🧤' },
  { id: 'punho_dragao', name: 'Manoplas do Horizonte', description: 'Slot: Punhos. Manoplas comerciais de alta potência inspiradas no Golpe do Dragão. Bônus: +24 ATQ e +5 KI.', category: 'wrists', price: 12000, minLevel: 15, atk: 24, ki: 5, icon: '🥊' },
  ...
  { id: 'armadura_freeza', name: 'Armadura de Elite Varth', description: 'Slot: Torso. Blindagem militar reforçada. Bônus: +18 DEF.', category: 'armor', price: 2400, minLevel: 6, def: 18, icon: '🦺' },
  ...
  { id: 'armadura_kaio', name: 'Armadura Celestial', description: 'Slot: Torso. Proteção divina comercial de alto nível. Bônus: +42 DEF e +5 KI.', category: 'armor', price: 15000, minLevel: 15, def: 42, ki: 5, icon: '🛡️' },
  { id: 'manto_kaioshin', name: 'Manto do Horizonte', description: 'Slot: Torso. Melhor proteção vendida pronta na loja. Bônus: +60 DEF e +8 KI.', category: 'armor', price: 34000, minLevel: 22, def: 60, ki: 8, icon: '🦺' },
  ...
  { id: 'calca_kaio_loja', name: 'Calça de Combate Astral', description: 'Slot: Pernas. Equipamento avançado de mobilidade e defesa. Bônus: +24 DEF, +10 VEL e +4 KI.', category: 'legs', price: 13500, minLevel: 16, def: 24, spd: 10, ki: 4, icon: '👖' },
  ...
  { id: 'botas_kaio_loja', name: 'Botas Celestiais', description: 'Slot: Botas. Melhor calçado comercial para combate de alta velocidade. Bônus: +26 VEL e +6 DEF.', category: 'boots', price: 14500, minLevel: 16, spd: 26, def: 6, icon: '🥾' },

  // Acessórios — dois podem ser equipados simultaneamente
  { id: 'medalhao_kame', name: 'Medalhão do Fluxo', description: 'Slot: Acessório I ou II. Medalhão equilibrado para iniciantes. Bônus: +3 ATQ e +3 DEF.', category: 'accessory', price: 900, minLevel: 2, atk: 3, def: 3, icon: '📿' },
  ...
  { id: 'coracao_dourado', name: 'Coração de Aethelgard', description: 'Slot: Acessório I ou II. Melhor acessório de combate vendido pronto. Bônus: +10 ATQ, +10 DEF, +10 KI e +10 VEL.', category: 'accessory', price: 26000, minLevel: 20, atk: 10, def: 10, ki: 10, spd: 10, icon: '💎' },
  { id: 'radar_esferas', name: 'Rastreador das Chaves', description: 'Slot: Acessório I ou II. Aumenta a chance da Busca pelas Esferas em +30 pontos percentuais, respeitando o teto mundial de 50%.', category: 'accessory', price: 500, currency: 'crystal', minLevel: 1, dragonBallSearchChanceBonus: 0.30, icon: '📡' },
  ...
  { id: 'senzu', name: 'Fruto de Sylva', description: 'Um fruto bioenergético de Sylva recupera 100% da vida ao liberar nutrientes e Aether armazenado.', category: 'consumable', price: 10, currency: 'crystal', minLevel: 1, effect: 'full_hp', icon: '🫘' },
  { id: 'elixir_dragao', name: 'Elixir do Horizonte', description: 'Poção mágica que desperta seu potencial oculto: +2 em TODOS os atributos (respeita o limite máximo).', category: 'consumable', price: 75, currency: 'crystal', minLevel: 5, effect: 'stat_boost', icon: '⚗️' },
  ...
  { id: 'gi_ponderado', name: 'Traje Gravitacional de Orin', description: 'Fibras densas e microatuadores tornam cada movimento um exercício de força e controle.', category: 'training', price: 60, currency: 'crystal', minLevel: 6, trainBonus: { all: 1 }, icon: '🐢' },
  ...
  { id: 'sala_tempo_capsula', name: 'Câmara Cronal Pessoal', description: 'Uma câmara experimental de Nexus-9 que intensifica a percepção temporal durante sessões de treino.', category: 'training', price: 450, currency: 'crystal', minLevel: 18, trainBonus: { all: 3 }, icon: '⏳' },
];
