...
export const TRANSFORMATIONS: TransformationDef[] = [
  // ===== Solaris: Fera Lupina → Ascensão Prateada → 3 ramos =====
  {
    ...
    name: 'Fera Lupina',
    race: 'saiyajin',
    description: 'A herança lupina desperta sob radiação lunar e comprime energia nos músculos, sentidos e ossatura.',
    icon: '🐺',
  ...
  },
  {
    ...
    race: 'saiyajin',
    description: 'A pelagem assume brilho prateado e a energia percorre o corpo em descargas controladas de plasma.',
    icon: '⚡',
  ...
  },
  {
    ...
    race: 'saiyajin',
    description: 'A energia é comprimida em musculatura e estrutura óssea, convertendo impulso estelar em força bruta.',
    icon: '💪',
  ...
  },
  {
    ...
    race: 'saiyajin',
    description: 'Instinto e razão entram em sincronia, distribuindo energia sem desperdício entre ataque, defesa e movimento.',
    icon: '⚡',
  ...
  },
  {
    ...
    race: 'saiyajin',
    description: 'Descargas percorrem a pelagem e explodem em rajadas rápidas, como uma tempestade estelar.',
    icon: '🌩️',
  ...
  // ===== Vanguardiano: Despertar Tático → Potencial Vanguardiano → ramos =====
  {
    id: 'humano_despertar',
    name: 'Despertar Tático',
    race: 'humano',
    description: 'Disciplina respiratória e treinamento de precisão abrem os canais internos de energia do Vanguardiano.',
    icon: '🌅',
  ...
  },
  {
    ...
    race: 'humano',
    description: 'Um protocolo de Aethel Prime libera reservas neuromusculares sem comprometer o controle do guerreiro.',
    icon: '✨',
  ...
  },
  {
    ...
    race: 'humano',
    description: 'Treino extremo reduz decisão e movimento a um único impulso, elevando reação e defesa a níveis excepcionais.',
    icon: '🌀',
  ...
  },
  {
    ...
    name: 'Disciplina Serena',
    race: 'humano',
    description: 'Respiração, postura e fluxo energético entram em equilíbrio, formando um guerreiro completo e estável.',
    icon: '☯️',
  ...
  },
  {
    ...
    race: 'humano',
    description: 'O guerreiro ancora múltiplas correntes de energia e as converte em uma única descarga de altíssima densidade.',
    icon: '🌟',
  ...
  },
  {
    ...
    race: 'namekuseijin',
    description: 'Tecidos vegetais mineralizam em combate e ampliam simultaneamente força, defesa e condução energética.',
    icon: '🌿',
  ...
  },
  {
    ...
    race: 'namekuseijin',
    description: 'A sintonia com as correntes de Sylva equilibra corpo, mente e energia em uma forma de proteção total.',
    icon: '🌳',
  ...
  },
  {
    ...
    race: 'namekuseijin',
    description: 'Memórias da rede viva de Sylva ampliam percepção e controle energético até o limite biológico.',
    icon: '📜',
  ...
  // ===== Sintético: Sobrecarga → Nano-melhorias → ramos =====
  {
    ...
    name: 'Sobrecarga',
    race: 'androide',
    description: 'Travas térmicas e de potência são temporariamente removidas para elevar a vazão do núcleo energético.',
    icon: '⚙️',
  ...
  },
  {
    ...
    race: 'androide',
    description: 'Coletores de contato drenam energia cinética e residual para alimentar subsistemas ofensivos.',
    icon: '🫱',
  ...
  },
  {
    ...
    race: 'androide',
    description: 'Toda a saída do núcleo é concentrada em um único disparo de alta voltagem e baixa duração.',
    icon: '⚡',
  ...
  },
  {
    ...
    name: 'Forma Original',
    race: 'majin',
    description: 'A forma primordial concentra massa, impulso e energia em uma configuração agressiva de alta densidade.',
    icon: '💥',
  ...
  },
  {
    ...
    race: 'majin',
    description: 'Símbolos de ressonância dimensional convertem instabilidade do Vazio em energia ofensiva concentrada.',
    icon: '🕯️',
