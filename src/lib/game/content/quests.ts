...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'dragao_7', category: 'collection', name: 'Colecionador de Esferas', description: 'Tenha as 7 Esferas do Dragão ao mesmo tempo.', metric: 'dragonBalls', target: 7, rewardZeni: 7000, rewardXp: 2000, rewardCrystals: 15, icon: '🔮' },
  // Progressão
