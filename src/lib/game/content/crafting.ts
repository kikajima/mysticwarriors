...
const SLOT_CRAFTED_ITEMS: ShopItem[] = [
  ...
  { id: 'lanca_saiyajin', name: 'Lança Solaris', description: 'Slot: Arma. Fabricação Tier 3. Bônus: +36 ATQ e +8 KI.', category: 'weapon', price: 0, minLevel: 1, atk: 36, ki: 8, icon: '🔱' },
  ...
  { id: 'visor_scouter_tatico', name: 'Visor de Fluxo Tático', description: 'Slot: Cabeça. Fabricação Tier 2. Bônus: +10 KI e +4 VEL.', category: 'head', price: 0, minLevel: 1, ki: 10, spd: 4, icon: '🥽' },
  { id: 'elmo_combate_saiyajin', name: 'Elmo de Combate Solaris', description: 'Slot: Cabeça. Fabricação Tier 3. Bônus: +15 DEF e +8 KI.', category: 'head', price: 0, minLevel: 1, def: 15, ki: 8, icon: '🪖' },
...
const ENDGAME_CRAFT_BANDS = [
  { id: 'ascendente', name: 'Ascendente', minLevel: 30, power: 105, costCréditos: 55_000, durationMin: 480, professionLevel: 8, materialQty: 2 },
  { id: 'divino_supremo', name: 'Divino Supremo', minLevel: 50, power: 160, costCréditos: 180_000, durationMin: 720, professionLevel: 9, materialQty: 4 },
  { id: 'cosmico_supremo', name: 'Cósmico Supremo', minLevel: 75, power: 235, costCréditos: 560_000, durationMin: 960, professionLevel: 10, materialQty: 6 },
  { id: 'eterno_supremo', name: 'Eterno Supremo', minLevel: 100, power: 330, costCréditos: 1_600_000, durationMin: 1320, professionLevel: 10, materialQty: 10 },
] as const;
...
const ENDGAME_CRAFT_RECIPES: CraftRecipeDef[] = ENDGAME_CRAFT_BANDS.flatMap((band) =>
  ENDGAME_CRAFT_SLOT_CONFIGS.map((slot) => ({
    ...
    costCréditos: band.costCréditos,
...
export const CRAFTED_ITEMS: ShopItem[] = [
  {
    ...
    name: 'Módulo de Recuperação Simples',
...
const SLOT_CRAFT_RECIPES: CraftRecipeDef[] = [
  // Arma — Tiers 1–5
  { id: 'craft_bastao_liga_leve', name: 'Bastão de Liga Leve', description: 'Arma: +5 ATQ.', tier: 1, icon: '🔧', outputItemId: 'bastao_liga_leve', outputQuantity: 1, outputKind: 'player_item', costCréditos: 180, baseDurationMin: 15, ingredients: [{ itemId: 'liga_metais_leves', quantity: 2 }, { itemId: 'faixa_pressao', quantity: 1 }] },
  { id: 'craft_lamina_carbono', name: 'Lâmina de Carbono', description: 'Arma: +10 ATQ e +2 VEL.', tier: 2, icon: '🗡️', outputItemId: 'lamina_carbono', outputQuantity: 1, outputKind: 'player_item', costCréditos: 700, baseDurationMin: 45, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[2] }], ingredients: [{ itemId: 'algema_carbono', quantity: 2 }, { itemId: 'liga_metais_leves', quantity: 2 }, { itemId: 'faixa_pressao', quantity: 1 }] },
  { id: 'craft_lanca_saiyajin', name: 'Lança Solaris', description: 'Arma: +18 ATQ e +4 KI.', tier: 3, icon: '🔱', outputItemId: 'lanca_saiyajin', outputQuantity: 1, outputKind: 'player_item', costCréditos: 2600, baseDurationMin: 120, professionRequirements: [{ professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[3] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[3] }], ingredients: [{ itemId: 'pesos_gravidade_10x', quantity: 1 }, { itemId: 'capsula_vazia_tipo_b', quantity: 1 }, { itemId: 'liga_metais_leves', quantity: 4 }, { itemId: 'planta_blindagem_flexivel', quantity: 1 }] },
  { id: 'craft_lamina_ki_condensado', name: 'Lâmina de Ki Condensado', description: 'Arma: +26 ATQ e +8 KI.', tier: 4, icon: '⚔️', outputItemId: 'lamina_ki_condensado', outputQuantity: 1, outputKind: 'player_item', costCréditos: 5600, baseDurationMin: 240, professionRequirements: [{ professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[4] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[4] }], ingredients: [{ itemId: 'pesos_gravidade_10x', quantity: 2 }, { itemId: 'microchip_controle', quantity: 3 }, { itemId: 'kevlar_alienigena', quantity: 2 }, { itemId: 'esquema_canalizacao_ki', quantity: 1 }] },
  { id: 'craft_espada_gravidade_100x', name: 'Espada de Gravidade 100x', description: 'Arma: +38 ATQ e +12 KI.', tier: 5, icon: '🌌', outputItemId: 'espada_gravidade_100x', outputQuantity: 1, outputKind: 'player_item', costCréditos: 15000, baseDurationMin: 480, professionRequirements: [{ professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[5] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[5] }], ingredients: [{ itemId: 'fluido_recuperacao_extrema', quantity: 2 }, { itemId: 'cristal_energia_ki', quantity: 2 }, { itemId: 'essencia_arvore_poder', quantity: 1 }, { itemId: 'esquema_gravidade_alterada', quantity: 1 }] },

  // Torso — Tiers 1, 2, 4 e 5 (Tier 3 usa Armadura de Combate Solaris)
  { id: 'craft_colete_fibra_reforcada', name: 'Colete de Fibra Reforçada', description: 'Torso: +5 DEF.', tier: 1, icon: '🥋', outputItemId: 'colete_fibra_reforcada', outputQuantity: 1, outputKind: 'player_item', costCréditos: 180, baseDurationMin: 15, ingredients: [{ itemId: 'fibra_reforcada', quantity: 2 }, { itemId: 'liga_metais_leves', quantity: 1 }] },
  { id: 'craft_colete_carbono_tatico', name: 'Colete de Carbono Tático', description: 'Torso: +10 DEF e +2 VEL.', tier: 2, icon: '🦺', outputItemId: 'colete_carbono_tatico', outputQuantity: 1, outputKind: 'player_item', costCréditos: 750, baseDurationMin: 50, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[2] }], ingredients: [{ itemId: 'algema_carbono', quantity: 2 }, { itemId: 'fibra_reforcada', quantity: 2 }, { itemId: 'liga_metais_leves', quantity: 1 }] },
  { id: 'craft_armadura_fluxo_ki', name: 'Armadura de Fluxo de Ki', description: 'Torso: +28 DEF e +10 KI.', tier: 4, icon: '🔷', outputItemId: 'armadura_fluxo_ki', outputQuantity: 1, outputKind: 'player_item', costCréditos: 6200, baseDurationMin: 270, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[4] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[4] }], ingredients: [{ itemId: 'kevlar_alienigena', quantity: 5 }, { itemId: 'microchip_controle', quantity: 3 }, { itemId: 'pesos_gravidade_10x', quantity: 1 }, { itemId: 'esquema_canalizacao_ki', quantity: 1 }] },
  { id: 'craft_armadura_gravidade_100x', name: 'Armadura de Gravidade 100x', description: 'Torso: +45 DEF e +12 KI.', tier: 5, icon: '🛡️', outputItemId: 'armadura_gravidade_100x', outputQuantity: 1, outputKind: 'player_item', costCréditos: 16500, baseDurationMin: 540, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[5] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[5] }], ingredients: [{ itemId: 'relatorio_ameaca_global', quantity: 2 }, { itemId: 'cristal_energia_ki', quantity: 2 }, { itemId: 'fluido_recuperacao_extrema', quantity: 1 }, { itemId: 'esquema_gravidade_alterada', quantity: 1 }] },

  // Acessório — Tiers 1, 3, 4 e 5 (Tier 2 usa Radar do Horizonte)
  { id: 'craft_pingente_foco_ki', name: 'Pingente de Foco de Ki', description: 'Acessório: +3 KI.', tier: 1, icon: '📿', outputItemId: 'pingente_foco_ki', outputQuantity: 1, outputKind: 'player_item', costCréditos: 160, baseDurationMin: 12, ingredients: [{ itemId: 'papel_pergaminho', quantity: 1 }, { itemId: 'liga_metais_leves', quantity: 1 }] },
  { id: 'craft_modulo_reacao_saiyajin', name: 'Módulo de Reação Solaris', description: 'Acessório: +6 KI e +5 VEL.', tier: 3, icon: '📟', outputItemId: 'modulo_reacao_saiyajin', outputQuantity: 1, outputKind: 'player_item', costCréditos: 2300, baseDurationMin: 110, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[3] }, { professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[3] }], ingredients: [{ itemId: 'capsula_vazia_tipo_b', quantity: 1 }, { itemId: 'kevlar_alienigena', quantity: 1 }, { itemId: 'microchip_controle', quantity: 2 }, { itemId: 'planta_blindagem_flexivel', quantity: 1 }] },
  { id: 'craft_nucleo_fluxo_ki', name: 'Núcleo de Fluxo de Ki', description: 'Acessório: +12 KI e +8 VEL.', tier: 4, icon: '💠', outputItemId: 'nucleo_fluxo_ki', outputQuantity: 1, outputKind: 'player_item', costCréditos: 5200, baseDurationMin: 220, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[4] }, { professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[4] }], ingredients: [{ itemId: 'microchip_controle', quantity: 4 }, { itemId: 'pesos_gravidade_10x', quantity: 1 }, { itemId: 'kevlar_alienigena', quantity: 1 }, { itemId: 'esquema_canalizacao_ki', quantity: 1 }] },
  { id: 'craft_nucleo_gravidade_100x', name: 'Núcleo de Gravidade 100x', description: 'Acessório: +6 ATQ, +16 KI e +12 VEL.', tier: 5, icon: '🌀', outputItemId: 'nucleo_gravidade_100x', outputQuantity: 1, outputKind: 'player_item', costCréditos: 14000, baseDurationMin: 450, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[5] }, { professionId: 'academico', level: CRAFT_TIER_PROFESSION_LEVEL[5] }], ingredients: [{ itemId: 'cristal_energia_ki', quantity: 2 }, { itemId: 'fragmento_tomo_ancestral', quantity: 1 }, { itemId: 'essencia_arvore_poder', quantity: 1 }, { itemId: 'esquema_gravidade_alterada', quantity: 1 }] },

  // Tier 1 — entrada livre
  { id: 'craft_bandana_oficina', name: 'Bandana Reforçada', description: 'Proteção leve para cabeça: +2 DEF e +2 KI.', tier: 1, icon: '🎗️', outputItemId: 'bandana_oficina', outputQuantity: 1, outputKind: 'player_item', costCréditos: 120, baseDurationMin: 10, ingredients: [{ itemId: 'papel_pergaminho', quantity: 1 }, { itemId: 'fibra_reforcada', quantity: 1 }] },
  { id: 'craft_munhequeiras_reforcadas', name: 'Munhequeiras Reforçadas', description: 'Equipamento de punhos: +3 ATQ.', tier: 1, icon: '🥊', outputItemId: 'munhequeiras_reforcadas', outputQuantity: 1, outputKind: 'player_item', costCréditos: 120, baseDurationMin: 10, ingredients: [{ itemId: 'faixa_pressao', quantity: 1 }, { itemId: 'fibra_reforcada', quantity: 1 }] },
  { id: 'craft_calca_treino_reforcada', name: 'Calça de Treino Reforçada', description: 'Equipamento de pernas: +3 DEF.', tier: 1, icon: '👖', outputItemId: 'calca_treino_reforcada', outputQuantity: 1, outputKind: 'player_item', costCréditos: 150, baseDurationMin: 12, ingredients: [{ itemId: 'fibra_reforcada', quantity: 2 }, { itemId: 'liga_metais_leves', quantity: 1 }] },
  { id: 'craft_botas_corrida_reforcadas', name: 'Botas de Corrida Reforçadas', description: 'Equipamento de botas: +3 VEL.', tier: 1, icon: '🥾', outputItemId: 'botas_corrida_reforcadas', outputQuantity: 1, outputKind: 'player_item', costCréditos: 150, baseDurationMin: 12, ingredients: [{ itemId: 'faixa_pressao', quantity: 1 }, { itemId: 'liga_metais_leves', quantity: 1 }] },

  // Tier 2 — carreira Nv. 2
  { id: 'craft_visor_scouter_tatico', name: 'Visor de Fluxo Tático', description: 'Cabeça: +5 KI e +2 VEL.', tier: 2, icon: '🕶️', outputItemId: 'visor_scouter_tatico', outputQuantity: 1, outputKind: 'player_item', costCréditos: 450, baseDurationMin: 30, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[2] }], ingredients: [{ itemId: 'microchip_controle', quantity: 2 }, { itemId: 'tinta_arcana', quantity: 1 }, { itemId: 'fibra_reforcada', quantity: 1 }] },
  { id: 'craft_luvas_impacto_carbono', name: 'Luvas de Impacto de Carbono', description: 'Punhos: +6 ATQ e +2 DEF.', tier: 2, icon: '🧤', outputItemId: 'luvas_impacto_carbono', outputQuantity: 1, outputKind: 'player_item', costCréditos: 500, baseDurationMin: 35, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[2] }], ingredients: [{ itemId: 'algema_carbono', quantity: 1 }, { itemId: 'faixa_pressao', quantity: 2 }, { itemId: 'liga_metais_leves', quantity: 1 }] },
  { id: 'craft_calca_compressao_tatica', name: 'Calça de Compressão Tática', description: 'Pernas: +6 DEF e +2 VEL.', tier: 2, icon: '🥋', outputItemId: 'calca_compressao_tatica', outputQuantity: 1, outputKind: 'player_item', costCréditos: 550, baseDurationMin: 35, professionRequirements: [{ professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[2] }], ingredients: [{ itemId: 'proteina_concentrada', quantity: 1 }, { itemId: 'fibra_reforcada', quantity: 2 }, { itemId: 'liga_metais_leves', quantity: 1 }] },
  { id: 'craft_botas_propulsao_tatica', name: 'Botas de Propulsão Tática', description: 'Botas: +6 VEL e +2 DEF.', tier: 2, icon: '👢', outputItemId: 'botas_propulsao_tatica', outputQuantity: 1, outputKind: 'player_item', costCréditos: 600, baseDurationMin: 40, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[2] }], ingredients: [{ itemId: 'microchip_controle', quantity: 1 }, { itemId: 'liga_metais_leves', quantity: 2 }, { itemId: 'faixa_pressao', quantity: 1 }] },

  // Tier 3 — duas carreiras Nv. 4 + blueprint
  { id: 'craft_elmo_combate_saiyajin', name: 'Elmo de Combate Solaris', description: 'Cabeça: +8 DEF e +4 KI.', tier: 3, icon: '🪖', outputItemId: 'elmo_combate_saiyajin', outputQuantity: 1, outputKind: 'player_item', costCréditos: 1800, baseDurationMin: 90, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[3] }, { professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[3] }], ingredients: [{ itemId: 'kevlar_alienigena', quantity: 2 }, { itemId: 'capsula_vazia_tipo_b', quantity: 1 }, { itemId: 'planta_blindagem_flexivel', quantity: 1 }] },
  { id: 'craft_braceletes_saiyajin', name: 'Braceletes Solaris', description: 'Punhos: +10 ATQ e +4 DEF.', tier: 3, icon: '💪', outputItemId: 'braceletes_saiyajin', outputQuantity: 1, outputKind: 'player_item', costCréditos: 1900, baseDurationMin: 90, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[3] }, { professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[3] }], ingredients: [{ itemId: 'kevlar_alienigena', quantity: 2 }, { itemId: 'pesos_gravidade_10x', quantity: 1 }, { itemId: 'planta_blindagem_flexivel', quantity: 1 }] },
  { id: 'craft_grevas_saiyajin', name: 'Grevas Solaris', description: 'Pernas: +10 DEF e +4 VEL.', tier: 3, icon: '🦿', outputItemId: 'grevas_saiyajin', outputQuantity: 1, outputKind: 'player_item', costCréditos: 2200, baseDurationMin: 105, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[3] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[3] }], ingredients: [{ itemId: 'kevlar_alienigena', quantity: 3 }, { itemId: 'capsula_vazia_tipo_b', quantity: 1 }, { itemId: 'planta_blindagem_flexivel', quantity: 1 }] },
  { id: 'craft_botas_saiyajin', name: 'Botas Solaris', description: 'Botas: +10 VEL e +4 DEF.', tier: 3, icon: '🥾', outputItemId: 'botas_saiyajin_craft', outputQuantity: 1, outputKind: 'player_item', costCréditos: 2200, baseDurationMin: 105, professionRequirements: [{ professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[3] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[3] }], ingredients: [{ itemId: 'pesos_gravidade_10x', quantity: 2 }, { itemId: 'capsula_vazia_tipo_b', quantity: 1 }, { itemId: 'planta_blindagem_flexivel', quantity: 1 }] },

  // Tier 4 — duas carreiras Nv. 6 + Esquema de Canalização de Ki
  { id: 'craft_visor_fluxo_ki', name: 'Visor de Fluxo de Ki', description: 'Cabeça: +12 KI e +5 VEL.', tier: 4, icon: '🔷', outputItemId: 'visor_fluxo_ki', outputQuantity: 1, outputKind: 'player_item', costCréditos: 4200, baseDurationMin: 180, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[4] }, { professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[4] }], ingredients: [{ itemId: 'microchip_controle', quantity: 4 }, { itemId: 'kevlar_alienigena', quantity: 3 }, { itemId: 'esquema_canalizacao_ki', quantity: 1 }] },
  { id: 'craft_manoplas_ki_condensado', name: 'Manoplas de Ki Condensado', description: 'Punhos: +14 ATQ e +6 KI.', tier: 4, icon: '💥', outputItemId: 'manoplas_ki_condensado', outputQuantity: 1, outputKind: 'player_item', costCréditos: 4500, baseDurationMin: 190, professionRequirements: [{ professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[4] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[4] }], ingredients: [{ itemId: 'pesos_gravidade_10x', quantity: 2 }, { itemId: 'microchip_controle', quantity: 3 }, { itemId: 'esquema_canalizacao_ki', quantity: 1 }] },
  { id: 'craft_calca_fluxo_ki', name: 'Calça de Fluxo de Ki', description: 'Pernas: +14 DEF e +5 KI.', tier: 4, icon: '🔹', outputItemId: 'calca_fluxo_ki', outputQuantity: 1, outputKind: 'player_item', costCréditos: 4700, baseDurationMin: 200, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[4] }, { professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[4] }], ingredients: [{ itemId: 'kevlar_alienigena', quantity: 3 }, { itemId: 'pesos_gravidade_10x', quantity: 2 }, { itemId: 'esquema_canalizacao_ki', quantity: 1 }] },
  { id: 'craft_botas_impulso_ki', name: 'Botas de Impulso de Ki', description: 'Botas: +14 VEL e +5 KI.', tier: 4, icon: '💨', outputItemId: 'botas_impulso_ki', outputQuantity: 1, outputKind: 'player_item', costCréditos: 4800, baseDurationMin: 200, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[4] }, { professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[4] }], ingredients: [{ itemId: 'capsula_vazia_tipo_b', quantity: 2 }, { itemId: 'pesos_gravidade_10x', quantity: 2 }, { itemId: 'esquema_canalizacao_ki', quantity: 1 }] },

  // Tier 5 — duas carreiras Nv. 8 + Esquema de Gravidade Alterada
  { id: 'craft_elmo_gravidade_100x', name: 'Elmo de Gravidade 100x', description: 'Cabeça: +16 DEF e +8 KI.', tier: 5, icon: '🌀', outputItemId: 'elmo_gravidade_100x', outputQuantity: 1, outputKind: 'player_item', costCréditos: 12000, baseDurationMin: 360, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[5] }, { professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[5] }], ingredients: [{ itemId: 'cristal_energia_ki', quantity: 2 }, { itemId: 'relatorio_ameaca_global', quantity: 1 }, { itemId: 'esquema_gravidade_alterada', quantity: 1 }] },
  { id: 'craft_manoplas_gravidade_100x', name: 'Manoplas de Gravidade 100x', description: 'Punhos: +20 ATQ e +8 DEF.', tier: 5, icon: '🌌', outputItemId: 'manoplas_gravidade_100x', outputQuantity: 1, outputKind: 'player_item', costCréditos: 12500, baseDurationMin: 380, professionRequirements: [{ professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[5] }, { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[5] }], ingredients: [{ itemId: 'fluido_recuperacao_extrema', quantity: 2 }, { itemId: 'cristal_energia_ki', quantity: 1 }, { itemId: 'esquema_gravidade_alterada', quantity: 1 }] },
  { id: 'craft_calca_gravidade_100x', name: 'Calça de Gravidade 100x', description: 'Pernas: +20 DEF e +8 VEL.', tier: 5, icon: '🌠', outputItemId: 'calca_gravidade_100x', outputQuantity: 1, outputKind: 'player_item', costCréditos: 13000, baseDurationMin: 400, professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[5] }, { professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[5] }], ingredients: [{ itemId: 'relatorio_ameaca_global', quantity: 2 }, { itemId: 'essencia_arvore_poder', quantity: 1 }, { itemId: 'esquema_gravidade_alterada', quantity: 1 }] },
  { id: 'craft_botas_gravidade_100x', name: 'Botas de Gravidade 100x', description: 'Botas: +20 VEL e +8 ATQ.', tier: 5, icon: '🚀', outputItemId: 'botas_gravidade_100x', outputQuantity: 1, outputKind: 'player_item', costCréditos: 13000, baseDurationMin: 400, professionRequirements: [{ professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[5] }, { professionId: 'atleta', level: CRAFT_TIER_PROFESSION_LEVEL[5] }], ingredients: [{ itemId: 'cristal_energia_ki', quantity: 2 }, { itemId: 'essencia_arvore_poder', quantity: 1 }, { itemId: 'esquema_gravidade_alterada', quantity: 1 }] },
];
...
export const CRAFT_RECIPES: CraftRecipeDef[] = [
  // ===== Blueprints Acadêmicos =====
  {
    ...
    name: 'Esquema de Detecção Ki',
    description: 'Projeto acadêmico usado no Radar do Horizonte Básico.',
    tier: 2,
    icon: '📡',
