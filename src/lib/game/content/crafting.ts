...
export const CRAFTED_ITEMS: ShopItem[] = [
  ...
  },
  {
    ...
    description: 'Proteção leve para a cabeça que estabiliza a concentração de Ki. Concede +3 Ki.',
    category: 'head',
    price: 0,
    minLevel: 1,
    ki: 3,
  ...
  },
  {
    ...
    description: 'Braçadeiras reforçadas para golpes corpo a corpo. Concede +6 Ataque e +2 Defesa.',
    category: 'wrists',
    price: 0,
    minLevel: 1,
    atk: 6,
  ...
  },
  {
    ...
    description: 'Calças reforçadas com pesos distribuídos. Concede +8 Defesa e +5 Velocidade.',
    category: 'legs',
    price: 0,
    minLevel: 1,
    def: 8,
  ...
  },
  {
    ...
    description: 'Botas com micropropulsores de Ki para arrancadas instantâneas. Concede +12 Velocidade e +6 Ki.',
    category: 'boots',
    price: 0,
    minLevel: 1,
    spd: 12,
