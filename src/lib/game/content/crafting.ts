...
export const CRAFT_RECIPES: CraftRecipeDef[] = [
  ...
  {
    id: 'blueprint_reforco_ki',
    name: 'Projeto de Reforço de Ki',
    description: 'Projeto obrigatório para equipamentos corporais Tier 4 com canais de Ki.',
    tier: 4,
    icon: '🔷',
    outputItemId: 'projeto_reforco_ki',
    outputQuantity: 1,
    outputKind: 'stack',
    costZeni: 1800,
    baseDurationMin: 150,
  ...
  // ===== Progressão completa dos slots corporais =====
  {
    id: 'visor_rastreador_ki',
    name: 'Visor Rastreador de Ki',
    description: 'Cabeça Tier 2: +4 Ki e +3 Velocidade.',
    tier: 2,
    icon: '🥽',
    outputItemId: 'visor_rastreador_ki',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 600,
    baseDurationMin: 35,
  ...
  },
  {
    id: 'capacete_combate_saiyajin',
    name: 'Capacete de Combate Saiyajin',
    description: 'Cabeça Tier 3: +8 Defesa e +5 Ki.',
    tier: 3,
    icon: '🪖',
    outputItemId: 'capacete_combate_saiyajin',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 2800,
    baseDurationMin: 135,
  ...
  },
  {
    id: 'elmo_sincronizacao_ki',
    name: 'Elmo de Sincronização de Ki',
    description: 'Cabeça Tier 4: +10 Defesa, +9 Ki e +4 Velocidade.',
    tier: 4,
    icon: '🧿',
    outputItemId: 'elmo_sincronizacao_ki',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 7000,
    baseDurationMin: 270,
    professionRequirements: [
      { professionId: 'cientista', level: CRAFT_TIER_PROFESSION_LEVEL[4] },
      { professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[4] },
    ],
    ingredients: [
      { itemId: 'cristal_energia_ki', quantity: 1 },
      { itemId: 'kevlar_alienigena', quantity: 3 },
      { itemId: 'projeto_reforco_ki', quantity: 1 },
    ],
  },
  {
    id: 'elmo_gravidade_divina',
    name: 'Elmo de Gravidade Divina',
    description: 'Cabeça Tier 5: +16 Defesa, +14 Ki e +6 Velocidade.',
    tier: 5,
    icon: '👑',
    outputItemId: 'elmo_gravidade_divina',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 18000,
    baseDurationMin: 600,
    professionRequirements: [
      ...
      { professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[5] },
    ],
    ingredients: [
      { itemId: 'cristal_energia_ki', quantity: 2 },
      { itemId: 'relatorio_ameaca_global', quantity: 2 },
      { itemId: 'esquema_gravidade_alterada', quantity: 1 },
    ],
  },

  {
    id: 'faixas_treinamento',
    name: 'Faixas de Treinamento',
    description: 'Punhos Tier 1: +3 Ataque.',
    tier: 1,
    icon: '🤜',
    outputItemId: 'faixas_treinamento',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 160,
    baseDurationMin: 10,
  ...
  },
  {
    id: 'manoplas_combate_saiyajin',
    name: 'Manoplas de Combate Saiyajin',
    description: 'Punhos Tier 3: +10 Ataque e +5 Defesa.',
    tier: 3,
    icon: '🧤',
    outputItemId: 'manoplas_combate_saiyajin',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 3000,
    baseDurationMin: 150,
    ...
    ingredients: [
      { itemId: 'pesos_gravidade_10x', quantity: 2 },
      { itemId: 'kevlar_alienigena', quantity: 2 },
      { itemId: 'planta_blindagem_flexivel', quantity: 1 },
    ],
  },
  {
    id: 'manoplas_fluxo_ki',
    name: 'Manoplas de Fluxo de Ki',
    description: 'Punhos Tier 4: +13 Ataque, +4 Defesa e +8 Ki.',
    tier: 4,
    icon: '✨',
    outputItemId: 'manoplas_fluxo_ki',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 6800,
    baseDurationMin: 270,
  ...
  },
  {
    id: 'manoplas_gravidade_divina',
    name: 'Manoplas de Gravidade Divina',
    description: 'Punhos Tier 5: +18 Ataque, +10 Defesa e +8 Ki.',
    tier: 5,
    icon: '💥',
    outputItemId: 'manoplas_gravidade_divina',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 19000,
    baseDurationMin: 630,
...

  {
    id: 'calcas_treinamento',
    name: 'Calças de Treinamento',
    description: 'Pernas Tier 1: +3 Defesa e +1 Velocidade.',
    tier: 1,
    icon: '👖',
    outputItemId: 'calcas_treinamento',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 170,
    baseDurationMin: 12,
  ...
  },
  {
    id: 'calcas_reforcadas',
    name: 'Calças Reforçadas',
    description: 'Pernas Tier 2: +5 Defesa e +3 Velocidade.',
    tier: 2,
    icon: '🥋',
    outputItemId: 'calcas_reforcadas',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 700,
    baseDurationMin: 40,
    professionRequirements: [{ professionId: 'policial', level: CRAFT_TIER_PROFESSION_LEVEL[2] }],
    ingredients: [
      { itemId: 'fibra_reforcada', quantity: 3 },
      { itemId: 'algema_carbono', quantity: 1 },
    ],
  },
  {
    id: 'calcas_fluxo_ki',
    name: 'Calças de Fluxo de Ki',
    description: 'Pernas Tier 4: +12 Defesa, +8 Velocidade e +4 Ki.',
    tier: 4,
    icon: '🌌',
    outputItemId: 'calcas_fluxo_ki',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 7200,
    baseDurationMin: 300,
    ...
    ingredients: [
      { itemId: 'kevlar_alienigena', quantity: 4 },
      { itemId: 'cristal_energia_ki', quantity: 1 },
      { itemId: 'projeto_reforco_ki', quantity: 1 },
    ],
  },
  {
    id: 'calcas_gravidade_divina',
    name: 'Calças de Gravidade Divina',
    description: 'Pernas Tier 5: +18 Defesa, +12 Velocidade e +6 Ki.',
    tier: 5,
    icon: '🌠',
    outputItemId: 'calcas_gravidade_divina',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 20000,
    baseDurationMin: 660,
...

  {
    id: 'botas_treinamento',
    name: 'Botas de Treinamento',
    description: 'Botas Tier 1: +3 Velocidade.',
    tier: 1,
    icon: '👟',
    outputItemId: 'botas_treinamento',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 160,
    baseDurationMin: 10,
  ...
  },
  {
    id: 'botas_reforcadas',
    name: 'Botas Reforçadas',
    description: 'Botas Tier 2: +6 Velocidade e +2 Defesa.',
    tier: 2,
    icon: '🥾',
    outputItemId: 'botas_reforcadas',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 650,
    baseDurationMin: 35,
  ...
  },
  {
    id: 'botas_gravidade_10x',
    name: 'Botas de Gravidade 10x',
    description: 'Botas Tier 3: +9 Velocidade, +4 Ataque e +3 Defesa.',
    tier: 3,
    icon: '🏋️',
    outputItemId: 'botas_gravidade_10x',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 3100,
    baseDurationMin: 150,
    ...
    ingredients: [
      { itemId: 'pesos_gravidade_10x', quantity: 2 },
      { itemId: 'capsula_vazia_tipo_b', quantity: 1 },
      { itemId: 'planta_blindagem_flexivel', quantity: 1 },
    ],
  },
  {
    id: 'botas_gravidade_divina',
    name: 'Botas de Gravidade Divina',
    description: 'Botas Tier 5: +18 Velocidade, +10 Ki e +5 Ataque.',
    tier: 5,
    icon: '☄️',
    outputItemId: 'botas_gravidade_divina',
    outputQuantity: 1,
    outputKind: 'player_item',
    costZeni: 21000,
    baseDurationMin: 660,
