...
export const WARRIOR_RANKING_CATEGORIES: ReadonlyArray<{
  ...
  { id: 'power', label: 'Nível de Poder', icon: '⚡', description: 'Poder atual do visor de fluxo, incluindo equipamentos e efeitos ativos.' },
  { id: 'tournament', label: 'Vitórias no Torneio', icon: '🏆', description: 'Total histórico de lutas vencidas no Grande Arena de Caelum.' },
