...
async function makePostgresLogicalBackup(
  ...
  const [
    ...
    db.marketTrade.findMany(),
    db.marketBuyOrder.findMany(),
    db.marketBuyOrderTrade.findMany(),
  ...
  const logical = {
    ...
    tables: {
      ...
      ChatFriendRequest: chatFriendRequests,
      ChatBlock: chatBlocks,
      InventoryStack: inventoryStacks,
      MarketListing: marketListings,
      MarketTrade: marketTrades,
      MarketBuyOrder: marketBuyOrders,
      MarketBuyOrderTrade: marketBuyOrderTrades,
      CraftJob: craftJobs,
      DragonBallPossession: dragonBallPossessions,
      PlayerNotification: playerNotifications,
    },
  };
