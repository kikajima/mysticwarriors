...
// * Atributos: apenas via addStat (sem teto de gameplay; proteção técnica de armazenamento);
...
async function actionStartTrain(tx: Tx, player: Player, stat: string): Promise<ActionResult> {
  ...
  // addStat sem teto de gameplay, trainingsDone, quests e analytics)
...
// Busca ativa separada dos turnos: procura consome TEMPO, não energia.
// O custo estratégico é ocupar o slot de atividade pela duração escolhida.
