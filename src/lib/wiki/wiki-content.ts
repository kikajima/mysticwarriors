...
export const WIKI_SECTIONS: WikiSection[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '**Aprenda sua primeira técnica** ([[tecnicas|Técnicas]]) — o Rogafufuken (600 Créditos) já deixa seus golpes físicos 25% mais fortes.',
  ...
  // ================================================================
  {
    ...
    blocks: [
      {
        kind: 'text',
        text: 'A primeira compra de qualquer guerreiro costuma ser o **Rogafufuken** (600 Créditos, nível 1): golpes físicos **25% mais fortes**. Lá no fim da jornada, a suprema **Convergência do Aether** multiplica por **1,75×** e perfura 30% da defesa — o golpe que apaga horizontes.',
      },
      {
        kind: 'text',
  ...
  // ================================================================
  {
    ...
    blocks: [
      ...
      {
        kind: 'text',
        text: `**Treinar é instantâneo:** clique no "+", o ponto entra na hora. Cada sessão custa **${TRAIN_ENERGY_COST} de energia** e Créditos que cresce conforme o atributo **base** sobe (Vanguardiano paga 10% menos). O ganho é +1 ponto — mais os bônus dos [[loja|equipamentos de treino]] que você possui. Na ficha, cada atributo aparece como **Total = Base + Equipamento**; por exemplo, Força 40 com +12 ATQ equipado aparece como Total 52, sem esconder o valor base.`,
      },
      {
        kind: 'callout',
        tone: 'info',
        title: 'Zenkai (Solaris)',
    ...
    blocks: [
      {
        ...
        table: {
          ...
          rows: [
            ['🟠 Solaris', '+8% dano físico; +10% XP de batalha; **Zenkai** (+1 Força ao perder para adversário relevante)', '—'],
            ['🟡 Vanguardiano', '+7% defesa; +2% dano de Ki', 'Energia regenera 10% mais rápido; treinos −10% de Créditos'],
            ['🟢 Verdant', '+5% dano de Ki; +4,5% esquiva', 'Vida regenera 15% mais rápido'],
            ['⚙️ Sintético', '+3,5% velocidade e +4,5% esquiva; +6% chance de atacar com Ki', '+5% de Créditos em trabalhos'],
  ...
  // ================================================================
  {
    ...
    blocks: [
      {
        kind: 'text',
        text: 'A árvore clássica: **Forma Base → Transformação I → Transformação II → três ramos finais** — você escolhe UM (A: físico, B: equilibrado, C: Ki). Desbloquear cada degrau exige nível (5 / 12 / 20), atributos e, em alguns casos, uma técnica específica ou um turno de profissão concluído (ex.: o Potencial Desbloqueado do Vanguardiano pede 1 trabalho de Acadêmico; o Caos Desencadeado do Amorph, 1 de Atleta).',
      },
      {
        kind: 'text',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '**Sintético:** o bônus racial de Créditos de trabalho continua valendo.',
        ],
      },
      {
        kind: 'details',
