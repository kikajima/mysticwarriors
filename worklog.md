...
- A6 nomes ORIGINAIS: 60 nomes no gerador (nenhum exato da franquia; sem 'Son' nos títulos; epítetos originais); 15 bots renomeados via scripts/rename-bots.ts (UPDATE preservando IDs/stats) — nomes públicos migrados para o elenco original do Setor Caelum, preservando IDs e estatísticas.
